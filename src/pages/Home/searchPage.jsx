...
import BarFilter from "../../../src/components/home/barFilter.jsx";
import {
  dataAdvertisement,
  dataAdvertisement1,
  dataAdvertisement2,
} from "../../data/dataObject.js";
import SlideAvertisement from "../../../src/components/home/slideAvertisement.jsx";
import MoreCategory from "../../../src/components/home/moreCategory.jsx";
...
const SearchPage = ({ route }) => {
  ...
  const [textSearch, setTextSearch] = useState(
    dataSearch?.textSearch ? dataSearch.textSearch : ""
  );
    ...
    <View style={{ flex: 1 }}>
      ...
      {listPipelineSec.length > 0 ? (
            ...
            listPipelineSec.length > 0 && (
              <View>
                <SuggestedProducts
                  ...
                  isLoading={isLoading}
                  namePipeline={dataSearch.namePipeline}
                />
              </View>
            )
          }
        ...
        <ScrollView style={{ flex: 1 }}>
          ...
          >
            <Image
              source={require("../../assets/thumb/notFoundProd.png")}
