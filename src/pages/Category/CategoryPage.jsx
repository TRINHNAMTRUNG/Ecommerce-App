...
import BarSearch from "../../../src/components/home/barSearch";

const CategoryPage = ({ navigation }) => {
  const typeIdDefault = "1111";
  const [listRoot, setListRoot] = useState([]);
  const [typeCatg, setTypeCateg] = useState({
    typeIdCatg: typeIdDefault,
      ...
      const list = [
        {
          name: "Gợi ý cho bạn",
          image:
            "https://res.cloudinary.com/dqxdekfst/image/upload/v1732764797/CloudinaryDemo/qh8od51zew6xhsrhbpgh.png",
          _id: typeIdDefault,
        },
